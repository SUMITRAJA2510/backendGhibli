        ...
        <div className="container mx-auto px-8 py-12">
            ...
            <div className="border-t border-gray-400/50 pt-6 flex flex-col md:flex-row justify-between items-center text-sm text-gray-600">
                ...
                <div className="flex space-x-4 mt-4 md:mt-0">
                    <a href="https://x.com/sumit__raja" target="_blank" className="hover:text-gray-900"><Twitter size={18}  /></a>
                    <a href="https://www.instagram.com/sumit__raja/" target="_blank" className="hover:text-gray-900"><Instagram size={18} /></a>
                    <a href="https://www.facebook.com/sumit.raja.77964" target="_blank" className="hover:text-gray-900"><Facebook size={18} /></a>
                </div>
            </div>
        </div>
    </footer>
